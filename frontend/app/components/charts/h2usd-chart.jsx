...
const H2usdChart = () => {
    ...
    const [priceaction, getPrice] = useState([]);  // y-axis
    const [timeaction, getTime] = useState([]);   // x-axis
    ...
    useEffect(() => {
      ...
      async function getChart() {
        ...
        const pricearray = output.chartPrice;  // y axis
        const timearray = output.chartTime;   // x-axis
        let price = []
        let time = []
        let i = 0
  ...
  return (
    <div>
      ...
      <div className="row col-lg-3">
        ...
        <img src='h2usd-logo.png' width='120' style={{opacity:'0.7'}}/>
        </div>
